...
The BASGRA NZ project tracks modifications to BASGRA for application in New Zealand conditions. The test data comes from the Seed Rate Trial at Scott Farm from 2011-2017. Modifications to BASGRA were necessary to represent this data.
