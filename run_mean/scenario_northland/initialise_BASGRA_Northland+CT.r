...
file_weather   <- paste(scenario, "/weather_Northland.txt", sep="")
...
file_harvest   <- paste(scenario, "/harvest_Northland_0.txt", sep="")
...
# use Lincoln water
file_weather_lincoln   <- paste(scenario, "/weather_Lincoln.txt", sep="")
lincoln_weather <- read_weather_WG(year_start,doy_start,NDAYS,file_weather_lincoln)
matrix_weather[,4:5] <- lincoln_weather[,4:5]
