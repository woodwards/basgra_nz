## 1. INITIALISATION ##
  library(tidyverse)
  cat(file=stderr(), 'Starting run_BASGRA_Northland.r', "\n")
  ...
  file_weather   <- 'model_inputs/weather_Northland.txt'
  ...
  days_harvest   <- as.matrix(read.table(file="model_inputs/harvest_Northland_3.txt", sep='\t'))
