...
## SETTINGS FOR THE DIFFERENT CALIBRATION SITES (at least one site)
   ...
   sitenames <- c(sitenames, "Canterbury-1")
   sitenumbers <- c(sitenumbers, 3)
   sitesettings_filenames <- c(sitesettings_filenames, paste(scenario, "/initialise_BASGRA_Lincoln-1.r", sep=""))
